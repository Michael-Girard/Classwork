/*
Program Name: AVLTree Display
Program Purpose: Display an AVL Tree with Balance Factor
Author: Michael Girard
Date Last Modified: February 21, 2015.
...
public class AVLDisplay extends Application {
   ...
   public void start(Stage primaryStage) {
      ...
      //Layout Code
      AVLView treeView = new AVLView(tree);
      ...
      primaryStage.setTitle("AVL Tree with Balance Factor (BF)");
...
class AVLView extends Pane{
   ...
   private void displayTree(BST.TreeNode<Integer> root, double x, double y, double hGap) {
      ...
      getChildren().addAll(circle, new Text(x - 14, y - 2, "  " + root.element + "\nBF: " + tree.balanceFactor((AVLTree.AVLTreeNode<Integer>)root)));
   }
}
